...
def main():
    ...
    print(f"Style parameters: BPM={style.bpm}, Swing={style.swing:.2f}, Intensity={style.intensity:.2f}")
    ...
    print(f"Original Intensity: {style.intensity:.2f}, New Intensity: {transformed_style.intensity:.2f}")
    
    # 4. Using phi-optimization
    print("\n4. Using phi-optimization...")
    # Optimize harmony and rhythm parameters using golden ratio
    optimized_style = style_manager.apply_phi_optimization(transformed_style, 
                                                          parameters=["harmony", "rhythm"])
